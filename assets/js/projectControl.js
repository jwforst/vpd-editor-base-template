...
document
  ...
  .classList.add(sessionFontFamily, sessionColorTheme);
...
function fontFamilyClicked(n) {
  ...
  console.log(
    "old classList (font family click) = " +
      document.getElementById("rootElement").classList
  );
  ...
  document
    .getElementById("rootElement")
    .classList.replace(oldFontFamily, sessionFontFamily);

  console.log(
    "classList after font family update = " +
      document.getElementById("rootElement").classList
  );
  console.log(" ");
}
...
function colorThemeClicked(n) {
  ...
  console.log(
    "old classList (color theme click) = " +
      document.getElementById("rootElement").classList
  );
  ...
  document
    .getElementById("rootElement")
    .classList.replace(oldColorTheme, sessionColorTheme);

  console.log(
    "classList after color theme update = " +
      document.getElementById("rootElement").classList
  );
  console.log(" ");
}
...
console.log(
  "classList at end of any update = " + document.getElementById("rootElement").classList
);
console.log();
